SELECT  info.departmentnm, info.sectionnm, info.lineno,info.cardno,  info.enmname_bangla, info.father_name_ban,  info.spouse_name_ban,  
        info.mother_name_ban, info.joining_date, other.birth_certificate_no,  other.nid, other.special_mark, info.birth_date,
        info.designation_bangla, info.salary_grade, (info.grosssalary + info.gross_bk) grosssalary, info.present_add_ban,
        info.present_po_ban,info.present_ps_ban,info.present_dist_ban,info.permanent_add_ban,info.permanent_po_ban,info.permanent_ps_ban,  
