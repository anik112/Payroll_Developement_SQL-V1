...
SELECT bonus.cardno, emp.departmentnm, emp.dept_bangla, emp.sectionnm, emp.sec_bangla, bonus.empname, bonus.enmname_bangla,bonus.lineno, bonus.lineno_bangla,
               ...
               bonus.grosssal, bonus.basicsal, bonus.payable_pt_ch, bonus.payment_pt_ch_rd, bonus.stamp, bonus.payment_pt_ch,bonus.calculation_status, bonus.bonus_category
FROM   TB_BONUS_AMOUNT_SP bonus, TB_PERSONAL_INFO emp
WHERE  bonus.company   = :p_company
AND    bonus.company       = emp.company
AND    bonus.finyear           = :p_year
...
SELECT bonus.cardno, emp.departmentnm, emp.dept_bangla, emp.sectionnm, emp.sec_bangla, bonus.empname, bonus.enmname_bangla, bonus.lineno_bangla,
       ...
       bonus.grosssal_bk, bonus.basicsal_bk, bonus.payable_pt_bk , bonus.payment_pt_bk_rd, bonus.payment_pt_bk, bonus.calculation_status, bonus.designation_ban,
       bonus.bonus_category, emp.ac_no, emp.mft_acno
FROM   TB_BONUS_AMOUNT_SP bonus, TB_PERSONAL_INFO emp
WHERE  bonus.company    = :p_company
AND    bonus.company        = emp.company
